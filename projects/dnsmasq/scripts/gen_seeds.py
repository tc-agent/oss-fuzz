...
RFC1035 = [
    ...
    # selectors 9-12 are FuzzPseudoheader / FuzzDoDoctor / FuzzSkip / FuzzPrivateNet
    (9, "pseudoheader_basic", dns_query_dnssec()),
    (9, "pseudoheader_resp", dns_a_response()),
    (10, "doctor_a", dns_a_response()),
    (10, "doctor_aaaa", dns_aaaa_response()),
    (11, "skip_query", dns_query()),
    (11, "skip_resp", dns_a_response()),
    (12, "private_v4", b"\x0a\x00\x00\x01" + b"\x00" * 12),
    (12, "private_v6", b"\xfe\x80" + b"\x00" * 14),
]
